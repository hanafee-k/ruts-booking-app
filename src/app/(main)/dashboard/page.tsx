...
export default function DashboardPage() {
      ...
      try {
        ...
        if (bookingsData && bookingsData.length > 0) {
          const formattedBookings: Booking[] = bookingsData.map((b: any) => ({
            id: b.id,
            room_name: b.rooms?.name || "ห้องไม่ระบุ", 
          ...
          setNextClass(formattedBookings[0]); 
        } else {
            setUpcomingBookings([]);
            setNextClass(null);
        }
  ...
  return (
    <div className="dashboard-page">
      ...
      {/* 🌟 ห่อหุ้มด้วย Grid สำหรับแยก 2 คอลัมน์บนจอคอม 🌟 */}
      <div className="desktop-dashboard-grid">
        
        {/* ================= คอลัมน์ซ้าย (บนคอม) / ส่วนบน (บนมือถือ) ================= */}
        <div className="dashboard-main-col">
          ...
          <div className="section-title-row" style={{ marginTop: '16px' }}>
          ...
          <section className="agenda-card">
            {nextClass ? (
              ...
              <div style={{ padding: '2rem', textAlign: 'center', color: '#ccc' }}>
                ...
                <button className="view-btn" style={{ marginTop: '10px', width: 'auto', padding: '8px 24px' }} onClick={() => navigateTo('/search')}>จองห้องเลย</button>
              </div>
            )}
          </section>
        </div>

        {/* ================= คอลัมน์ขวา (บนคอม) / ส่วนล่าง (บนมือถือ) ================= */}
          ...
          <section className="upcoming-section">
            ...
            <div className="upcoming-list">
              {upcomingBookings.length > 0 ? (
                ...
                <div className="no-results" style={{ padding: '1rem', background: '#fff', borderRadius: '12px', textAlign: 'center' }}>
